...
#define ROSBAG2_BAG_V2_PLUGINS_LOG_INFO_STREAM(args) do { \
    ...
    __ss << args; \
    RCUTILS_LOG_INFO_NAMED(ROSBAG2_BAG_V2_PLUGINS_PACKAGE_NAME, "%s", __ss.str().c_str()); \
} while (0)
...
#define ROSBAG2_BAG_V2_PLUGINS_LOG_ERROR_STREAM(args) do { \
    std::stringstream __ss; \
    __ss << args; \
    RCUTILS_LOG_ERROR_NAMED(ROSBAG2_BAG_V2_PLUGINS_PACKAGE_NAME, "%s", __ss.str().c_str()); \
} while (0)
...
#define ROSBAG2_BAG_V2_PLUGINS_LOG_WARN_STREAM(args) do { \
    std::stringstream __ss; \
    __ss << args; \
    RCUTILS_LOG_WARN_NAMED(ROSBAG2_BAG_V2_PLUGINS_PACKAGE_NAME, "%s", __ss.str().c_str()); \
} while (0)
...
#define ROSBAG2_BAG_V2_PLUGINS_LOG_DEBUG_STREAM(args) do { \
    std::stringstream __ss; \
    __ss << args; \
    RCUTILS_LOG_DEBUG_NAMED(ROSBAG2_BAG_V2_PLUGINS_PACKAGE_NAME, "%s", __ss.str().c_str()); \
} while (0)
